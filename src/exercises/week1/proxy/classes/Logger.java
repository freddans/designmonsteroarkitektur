...
public class Logger {
  ...
  private static final String FILE_NAME_PATH = "src/exercises/week1/proxy/files/log.txt";
  ...
  public void log(Date date, String activity, String msg) {
    try (BufferedWriter writer = new BufferedWriter(new FileWriter(FILE_NAME_PATH, true))) {
