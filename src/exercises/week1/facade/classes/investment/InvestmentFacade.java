package exercises.week1.facade.classes.investment;

import exercises.week1.facade.classes.services.FundService;
import exercises.week1.facade.classes.services.OptionService;
import exercises.week1.facade.classes.services.StockService;
...
public class InvestmentFacade {
  ...
  public boolean invest(String userId, String type, int amount) {
